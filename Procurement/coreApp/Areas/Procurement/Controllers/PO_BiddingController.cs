...
namespace coreApp.Areas.Procurement.Controllers
{
    ...
    public class PO_BiddingController : ProcurementBaseController, IYearController
    {
        public int Year { get; set; }
        
        public ActionResult Index()
        {
            POModels_Bidding model = new POModels_Bidding(Year);
            return View(model);
        }

        public ActionResult Details(int? id, bool iscpr = false)
        {
            if (id == null)
            {
                ...
                using (procurementDataContext context = new procurementDataContext())
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        tblPO po = new tblPO
                        {
                            ...
                            ForPublicBidding = true,
                            ForPublicBidding_SupplierId = model.ForPublicBidding_SupplierId
                        };
            ...
            try
            {
                using (procurementDataContext context = new procurementDataContext())
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        po.ForPublicBidding_SupplierId = model.ForPublicBidding_SupplierId;
        ...
        public ActionResult Submit(int id)
        {
            ...
            try
            {
                using (procurementDataContext context = new procurementDataContext())
                {
                    ...
                    if (string.IsNullOrEmpty(po.ForPublicBidding_CPRIds))
                    {
        ...
        public ActionResult Return(int id, string returnMessage)
        {
            ...
            try
            {
                using (procurementDataContext context = new procurementDataContext())
                {
                    ...
                    var referringPOs = cpr.ReferringPOs();
