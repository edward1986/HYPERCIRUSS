...
namespace zks_console
{
    ...
    {
        int getErrorCode();
        TmpUploadResult GetLogs(int n, string ip, int port, int pw, DateTime startDate, DateTime endDate);
        void Dispose();
    };
    ...
    {       
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                if (args.Length > 6)
                {
                    startDate = DateTime.Parse(args[6]);
                    endDate = DateTime.Parse(args[7]);
                }
