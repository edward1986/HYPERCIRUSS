...
namespace Devices
{
    ...
    public class INO1_A_Legacy : clDevice
    {
        public zkemkeeper.CZKEM axCZKEM1 = new zkemkeeper.CZKEM();

        public INO1_A_Legacy()
            : base(2, 3, 4, true, false)
        {
        ...
        {
            logItem.IdNo = cells[r, _idNo_ColNo].Value.ToString();
            logItem.LogDate = cells[r, _logDate_ColNo].Value.ToString();
            logItem.Mode = cells[r, _mode_ColNo].Value.ToString();
        }
